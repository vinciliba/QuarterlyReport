        ...
        tbl_grants_tts_overview = (
            ...
            .tab_style(
              ...
              .tab_style(
                style=[
                    style.fill(color=LIGHT_BLUE),
                    style.text( weight="bold", align='left', size = 'medium'),
                ],
                locations=loc.stubhead()
            )
            ...
            Completion_Rate=html(
                "Completion Rate <span style='font-size: medium;'> (8)</span> <br> --------------------------</br> "
                "<span style='font-size: small;'>(Main + Reserve lists)</span>"
                )   
            )
            .tab_style(
